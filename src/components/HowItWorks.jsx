...
export const HowItWorks = ({
  ...
  const steps = [
    {
      ...
      description:
        "Install sensors that are compatible with selected industrial machinery.",
      detail:
        "Quick magnetic or stud-mount sensor pods snap securely onto cast iron or alloy bearing housings without drilling, welding, or interrupting active plant production.",
      badge: "Plug & Play",
    ...
    },
    {
      ...
      description:
        "Gather data related to vibration, noise, and temperature from these sensors.",
      detail:
        "Continuous edge data acquisition streams high-frequency vibration, ultrasonic acoustic emissions, and thermal gradients around the clock.",
    ...
    },
    {
      ...
      description:
        "Analyze the collected data and detect any changes in the working condition of equipment",
      detail:
        "Embedded Nvidia Jetson Orin AI cores run cuDF FFT transforms and spectral anomaly detection on-premise, flagging early sub-surface cavitation, imbalance, and bearing raceway spalling.",
    ...
    },
    {
      ...
      detail:
        "Multi-channel dispatch broadcasts clear, plain-English notifications directly to operators via SMS, WhatsApp, Slack, email, and plant SCADA webhooks with precise root cause diagnostics.",
      badge: "Instant Dispatch",
      metric: "< 200 ms Notification Speed",
      subtext:
        "Multi-Channel Broadcast • WhatsApp / SMS / Slack • Root Cause Summary",
    ...
    },
    {
      ...
      detail:
        "Maintenance teams review component failure recommendations, auto-generate work orders for SAP PM or IBM Maximo, and perform targeted service during scheduled shift transitions before catastrophic failure.",
      badge: "Actionable Maintenance",
      metric: "Zero Unplanned Outages",
      subtext:
        "Automated Work Order Drafts • Step-by-Step Fixes • Downtime Averted",
  ...
  return (
    <section
      id="how-it-works"
      className="py-24 bg-[#06080d] relative overflow-hidden border-t border-blue-900/30"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            An end-to-end industrial intelligence workflow designed to monitor
            critical plant machinery, detect micro-anomalies early, and direct
            targeted maintenance before downtime occurs.
          </p>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1">
                  <h3
                    className={`font-bold text-xs tracking-wider uppercase line-clamp-1 ${
                ...
                <div className="mt-4 pt-2 border-t border-slate-800/50 flex items-center justify-between text-[10px] font-mono">
                  ...
                  <div
                    className={`w-1.5 h-1.5 rounded-full ${isSelected ? "bg-blue-400 animate-ping" : "bg-slate-700"}`}
                  />
                </div>
              </button>
            );
        ...
        <div className="rounded-3xl bg-[#0b0f19] border border-blue-500/30 p-6 sm:p-10 shadow-glow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <button
                onClick={() =>
                  onOpenDashboard ? onOpenDashboard() : handleExplore()
                }
