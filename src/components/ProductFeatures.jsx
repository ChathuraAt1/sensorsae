...
export const ProductFeatures = ({ onRequestDemo, onExploreProducts }) => {
  ...
  const capabilities = [
    {
      ...
      description:
        "Standard sensors only alert you after bearing damage causes heavy oscillations. SENSORSAE's high-frequency acoustic listening arrays capture micro-friction at early stages of lubrication breakdown, giving your team time to schedule maintenance during regular shift transitions.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Factory technicians shouldn't need a specialist in digital signal processing to understand machine alerts. SENSORSAE's local diagnostic engine interprets vibration signatures and dispatches clear, actionable repair recommendations directly to maintenance tablets and smartphones.",
      highlights: [
    ...
    },
    {
      ...
      tagline:
        "Safely monitor high-voltage lines and pump seals from a distance.",
      description:
        "Continuous long-wave infrared (LWIR) optical cameras detect overheating motor windings, loose electrical busbars, and pump seal leaks safely from a standoff distance without requiring physical contact with dangerous or moving machinery.",
      highlights: [
    ...
    },
    {
      ...
      tagline:
        "No conduit routing, no drilling, and no production line pauses.",
      description:
        "Engineered specifically for operating factory floors where halting a production line is costly. High-strength magnetic bases attach securely onto cast iron or steel motor housings, communicating immediately with your local plant hub.",
      highlights: [
  ...
  return (
    <section
      id="features"
      className="py-20 bg-[#080c14] border-y border-blue-950/40 relative"
    >
      <div className="max-w-7xl mx-auto px-6 space-y-12 relative">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-slate-400 text-base max-w-xl mx-auto">
            Explore monitoring capabilities designed to support equipment
            visibility and maintenance planning.
          </p>
        </div>
              ...
              <div className="relative rounded-3xl overflow-hidden border border-blue-500/30 bg-[#06080d] group">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between bg-[#06080d]/85 backdrop-blur-md px-4 py-2 rounded-2xl border border-slate-800 text-xs">
                  <span className="text-slate-400 font-mono text-[11px]">
                    Viewing capability{" "}
                    <strong className="text-white">{activeTab + 1} of 4</strong>
                  </span>
