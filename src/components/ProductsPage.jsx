  ...
  const machineApplications = [
    {
      ...
      failureModes:
        "Impeller cavitation, seal friction, shaft deflection, bearing race fatigue.",
      earlySymptom:
        "High-frequency ultrasonic noise spikes (20 kHz–80 kHz) indicative of micro-bubble collapse 3–6 weeks before thermal rise.",
      sensorSetup:
        "2x Wireless Magnetic Pods (drive-end & non-drive-end bearings) + 1x Thermal Guard camera pointed at mechanical seal gland.",
    },
    {
      id: "motors",
      ...
      failureModes:
        "Stator winding hotspots, rotor bar cracking, phase unbalance, electrical bearing fluting.",
      earlySymptom:
        "Sideband harmonic modulation around 2x line frequency (120 Hz) and high-frequency EDM discharge signatures.",
      sensorSetup:
        "1x Wireless Magnetic Pod on motor drive-end casing + integration with motor drive current telemetry over Modbus TCP.",
    },
    {
      id: "gearboxes",
      ...
      failureModes:
        "Gear tooth micro-pitting, gear backlash, shaft misalignment, lubricating oil breakdown.",
      earlySymptom:
        "Gear mesh frequency (GMF) sideband energy elevation and high crest factor time-waveform peaks.",
      sensorSetup:
        "2x Wireless Magnetic Pods positioned orthogonal to gear mesh plane + 1x Pt100 RTD oil sump probe.",
    },
    {
      id: "cnc",
      ...
      failureModes:
        "Ceramic hybrid ball bearing spalling, toolholder runout, drawbar spring degradation.",
      earlySymptom:
        "Sub-harmonic vibration emergence in 5 kHz–15 kHz band causing micro-chatter on finished surface tolerances.",
      sensorSetup:
        "1x Hardwired IEPE accelerometer on spindle nose + 1x Thermal Guard inspecting tool changer collets.",
    },
    {
      id: "compressors",
      ...
      failureModes:
        "Rotor lobe wear, valve plate flutter, cylinder lubrication starvation, stage pressure surge.",
      earlySymptom:
        "Transient acoustic emission clicks during intake stroke prior to discharge temperature rise.",
      sensorSetup:
        "4x Wireless Magnetic Pods monitoring both compression stages and motor bearings.",
    },
    {
      id: "conveyors",
      ...
      failureModes:
        "Idler roller seizure, drive sprocket tooth wear, carrier bearing overheating.",
      earlySymptom:
        "Localized thermal friction delta-T above 15°C detected by automated optical patrol camera.",
      sensorSetup:
        "Thermal Vision Guard with continuous multi-point region-of-interest (ROI) monitoring.",
    },
  ];
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-[#06080d] text-slate-100 font-sans">
      <div className="max-w-6xl mx-auto px-6 space-y-28">
        ...
        <div className="space-y-8">
          ...
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
              Rugged edge gateways, magnetic wireless pods, and on-premises
              Nvidia Orin™ neural engines built to eliminate unplanned
        ...
        <section
          id="prod-edge-x1"
          className="scroll-mt-36 rounded-3xl bg-[#0b0f19] border border-blue-900/40 p-8 sm:p-12 space-y-8"
        >
          <div className="space-y-6">
            <div className="space-y-4 max-w-4xl">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                The rugged central computing station installed on plant floor
                walls or DIN rails. It aggregates high-frequency vibration,
                acoustics, and temperature telemetry directly at the machine
                face, running neural models locally with zero cloud lag.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300 font-sans pt-2">
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  IP67 waterproof, dustproof, and fanless convection aluminum chassis
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Aggregates up to 32 wireless magnetic pods with 1.2 km line-of-sight range
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  4x IEPE/ICP analog ports for high-bandwidth hardwired accelerometers
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Isolated dual 24V DC industrial power input with reverse polarity protection
                </span>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <button
                onClick={() =>
                  onOpenDashboard && onOpenDashboard({ tab: "sensors" })
                }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-slate-800/80">
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1">
              ...
              <p className="text-xs text-slate-300">
                Dual Gigabit Ethernet, RS-485 Modbus RTU, USB-C diagnostic
                console, and external SMA sub-GHz antenna.
              </p>
            </div>
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1">
              <span className="font-mono text-xs text-blue-400 font-bold block">
              ...
              <p className="text-xs text-slate-300">
                -40°C to +85°C rated for unconditioned factory environments,
                foundry floors, and boiler rooms.
              </p>
            </div>
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1">
              <span className="font-mono text-xs text-blue-400 font-bold block">
              ...
              <p className="text-xs text-slate-300">
                512 GB industrial NVMe storage for raw uncompressed spectrum
                logging and offline telemetry recall.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="space-y-6">
            <div className="space-y-4 max-w-4xl">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Untethered, battery-operated vibration and acoustic pods built
                for fast machine retrofitting. Deploy across motors, pumps, and
                gearboxes in minutes without conduit wiring, drilling, or
                production halts.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300 font-sans pt-2">
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  120 kg neodymium magnetic breakaway base locks securely onto curved cast iron
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Tri-axial accelerometer + ultrasonic acoustic microphone (up to 192 kHz)
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  5-Year field-replaceable lithium battery with smart sleep/wake duty cycling
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Sub-GHz wireless mesh penetrates heavy reinforced concrete and steel enclosures
                </span>
              </div>
            </div>
        ...
        >
          <div className="space-y-6">
            <div className="space-y-4 max-w-4xl">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Empower your plant maintenance technicians with plain-English
                conversational triage. Instead of staring at dense Fourier
                transform charts, technicians ask questions from any browser,
                tablet, or phone.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300 font-sans pt-2">
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Ask in natural language: "Which machines need lubrication before Monday shift?"
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Automated ISO 10816/20816 vibration severity categorization and root-cause breakdown
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Generates step-by-step repair checklists, part numbers, and torque specifications
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  1-Click work order synchronization to SAP PM, IBM Maximo, or printable shift PDF
                </span>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <button
                onClick={() =>
                  onOpenDashboard && onOpenDashboard({ tab: "copilot" })
                }
                className="px-5 py-2.5 rounded-full bg-[#06080d] hover:bg-blue-950 text-blue-300 text-xs font-mono border border-slate-800 hover:border-blue-500 transition-all flex items-center gap-2"
              >
        ...
        >
          <div className="space-y-6">
            <div className="space-y-4 max-w-4xl">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Continuous non-contact infrared thermal imaging designed for
                hazardous, high-voltage, or fast-moving plant machinery. Stand
                off up to 30 meters away to detect overheating electrical
                busbars, loose terminations, and bearing hot-spots safely.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300 font-sans pt-2">
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Calibrated radiometric measurement range: -40°C to +1,200°C
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  ±0.5°C thermal precision with differential delta threshold alarms
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Automated AI hot-spot bounding boxes track moving components across field of view
                </span>
              </div>
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#06080d] border border-slate-800/80">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                <span>
                  Eliminates hazardous manual thermal gun inspections near 480V switchgear
                </span>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <button
                onClick={() =>
                  onOpenDashboard && onOpenDashboard({ tab: "thermal" })
                }
                className="px-5 py-2.5 rounded-full bg-[#06080d] hover:bg-blue-950 text-blue-300 text-xs font-mono border border-slate-800 hover:border-blue-500 transition-all flex items-center gap-2"
              >
        ...
        <section
          id="prod-orin"
          className="scroll-mt-36 rounded-3xl bg-gradient-to-r from-blue-950/40 via-[#0b0f19] to-blue-950/40 border border-blue-500/40 p-8 sm:p-12 space-y-8"
        >
          <div className="space-y-6">
            <div className="space-y-4 max-w-4xl">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                By integrating Nvidia Jetson Orin compute modules directly
                inside our Edge-X1 hardware, all heavy vibration transforms and
                AI inferences execute right at the machine face. No cloud
                latency, no subscription egress bills, and zero security risk.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1 font-mono text-xs">
              <div className="p-4 rounded-xl bg-[#06080d] border border-blue-900/40 flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" />
                <div>
                  <strong className="text-white block font-sans">
                    275 TOPS INT8 Local AI Processing
                  </strong>
                  <span className="text-slate-400 font-sans text-[11px]">
                    Enables real-time FFT frequency transforms and concurrent
              ...
              <div className="p-4 rounded-xl bg-[#06080d] border border-blue-900/40 flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-slate-400 font-sans text-[11px]">
                    Micro-quantized models serve acoustic diagnostics and
                    thermal bounding concurrently.
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#06080d] border border-blue-900/40 flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white block font-sans">
                    Nvidia DeepStream™ Vision Pipeline
                  </strong>
                  <span className="text-slate-400 font-sans text-[11px]">
                    Hardware-accelerated processing of radiometric infrared
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <button
                onClick={() =>
                  onOpenDashboard && onOpenDashboard({ tab: "orin" })
                }
                className="px-5 py-2.5 rounded-full bg-[#06080d] hover:bg-blue-950 text-blue-300 text-xs font-mono border border-slate-800 hover:border-blue-500 transition-all flex items-center gap-2"
              >
                <Cpu className="w-3.5 h-3.5" />
        ...
        >
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              How SENSORSAE isolates sub-surface fatigue weeks before
              conventional vibration sensors notice bulk oscillations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 font-sans text-xs">
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-slate-400 leading-relaxed">
                Filters out low-frequency structural machine noise, isolating
                repetitive micro-impacts generated by rolling elements striking
                microscopic race fissures.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <h3 className="font-bold text-white text-sm">
                ISO 10816 / 20816 Scoring
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Calculates true root-mean-square (RMS) vibration velocity (mm/s
                and in/s) against ISO severity charts for Class I, II, III, and
                IV machinery.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-slate-400 leading-relaxed">
                Normalizes dynamic machine speed variations on VFDs into exact
                shaft rotational multiples (1X unbalance, 2X misalignment, GMF
                gear mesh).
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-slate-400 leading-relaxed">
                Statistical wave-shape analysis calculating peak-to-RMS ratios
                to distinguish sharp cavitation impacts from normal background
                motor hum.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#06080d] border border-blue-900/40 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <span className="text-white font-bold text-xs block">
                Inspect Real-Time Harmonic Spectrum
              </span>
              <p className="text-slate-400 text-xs">
                Test real-time peak picking (1X, 2X, BPFO) with dynamic ISO
                10816 threshold limits.
              </p>
            </div>
            <button
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm max-w-xl">
                Select an equipment family below to explore typical failure
                modes and recommended sensor deployment.
              </p>
            </div>

            <span className="font-mono text-xs text-blue-400 shrink-0">
              {activeAppIndex + 1} of {machineApplications.length} Equipment
              Types
            </span>
          </div>
          ...
          <div className="rounded-2xl bg-[#06080d] border border-slate-800 p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-300">
              <div className="p-4 rounded-xl bg-[#0b0f19] border border-slate-800 space-y-1.5">
                ...
                <p className="text-slate-200 mt-0.5 leading-relaxed">
                  {currentApp.failureModes}
                </p>
              </div>

              <div className="p-4 rounded-xl bg-[#0b0f19] border border-slate-800 space-y-1.5">
                <span className="text-blue-400 font-mono block text-[10px] uppercase">
                  EARLIEST DETECTABLE SYMPTOM:
                </span>
                <p className="text-slate-300 mt-0.5 leading-relaxed">
                  {currentApp.earlySymptom}
                </p>
              </div>

              <div className="p-4 rounded-xl bg-[#0b0f19] border border-blue-900/40 space-y-1.5">
        ...
        >
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              No cable pulling, no drilling into machine casings, and no
              production line shutdowns required.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3 relative">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Wipe the cast iron casing clean, apply acoustic couplant, and
                snap the 120 kg neodymium pod base firmly into place.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3 relative">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Tap the pod with the setup tablet to assign equipment tags (e.g.
                Pump 4B) and establish secure encrypted sub-GHz mesh link.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3 relative">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                The local hub monitors the machine across 72 hours of operating
                cycles, learning normal running frequencies and baseline heat
                signatures.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3 relative">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Connect your team's WhatsApp, SMS, or SAP PM endpoints to
                receive plain-English shift work orders the moment wear is
                isolated.
              </p>
            </div>
          </div>
        ...
        >
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              SENSORSAE is designed to slip seamlessly into existing plant
              control architectures without requiring expensive PLC programming
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Native out-of-the-box support for OPC UA, Modbus TCP/RTU, MQTT
                Sparkplug B, Profinet, and EtherCAT to stream health tags
                directly into PLCs.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Direct connectors for Rockwell FactoryTalk, Siemens WinCC,
                Ignition SCADA, AVEVA PI System, and Wonderware without
                middleware bloat.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#06080d] border border-slate-800 space-y-3">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Automated work order creation in SAP Plant Maintenance (PM), IBM
                Maximo, eMaint, and MaintainX when vibration thresholds exceed
                ISO norms.
              </p>
            </div>
          </div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Critical manufacturing facilities cannot gamble with cloud
                uptime or third-party data breaches. SENSORSAE's entire
                inference and storage pipeline runs strictly within your
                physical perimeter.
              </p>
            </div>
        ...
        >
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              Every sensor enclosure and compute chassis is built and
              independently certified for continuous exposure to vibration,
              caustic chemicals, and extreme temperatures.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono text-xs">
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-400 text-[11px] font-sans">
                Hermetically sealed against high-pressure washdown and caustic
                CIP spray.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-400 text-[11px] font-sans">
                Certified for hazardous atmospheres with potential flammable
                vapors or dust.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-400 text-[11px] font-sans">
                Tested to endure 50g operational shock and continuous random
                chassis vibration.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#06080d] border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-400 text-[11px] font-sans">
                Heavy industrial electromagnetic immunity protecting against arc
                welding spikes.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-xs text-slate-400">
                Pre-configured with Nvidia Jetson Orin compute, internal
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-xs text-slate-400">
                Wireless tri-axial vibration and acoustic sensors with 120 kg
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-xs text-slate-400">
                Radiometric LWIR infrared camera module with universal clamp
                bracket.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#06080d] border border-slate-800 space-y-2.5">
              ...
              <p className="text-xs text-slate-400">
                Pre-installed software runtime, quick-start guide, and engineer
                phone onboarding.
              </p>
            </div>
          </div>
        ...
        <section
          id="prod-calculator"
          className="scroll-mt-36 rounded-3xl bg-[#0b0f19] border border-blue-500/30 p-8 sm:p-12 space-y-8"
        >
          <div className="max-w-3xl space-y-3">
            <span className="font-mono text-xs text-blue-400 font-bold uppercase tracking-wider">
              PILOT CONFIGURATOR
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              Calculate the recommended hardware configuration for your machine
              bay or production line.
            </p>
          </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div>
                <label className="block text-xs font-mono uppercase text-slate-400 mb-2">
                  Number of Target Machines to Monitor:{" "}
                  <span className="text-blue-400 font-bold text-sm">
                    {pilotMachines} Machines
                  </span>
                </label>
                <input
                  type="range"
              ...
              <div className="space-y-2 text-slate-300">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white font-bold">
                    {Math.max(1, Math.ceil(pilotMachines / 20))} Unit
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Wireless Magnetic Pods:</span>
                  <span className="text-blue-400 font-bold">
                    {pilotMachines * 2} Pods (Dual-Bearing)
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Thermal Vision Guard:</span>
                  <span className="text-white font-bold">
                    {Math.max(1, Math.ceil(pilotMachines / 8))} Camera
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Est. Setup Time:</span>
                  <span className="text-emerald-400 font-bold">
                    &lt; {pilotMachines * 8} Minutes Total
                  </span>
                </div>
              </div>
        ...
        <section
          id="prod-faq"
          className="scroll-mt-36 rounded-3xl bg-[#0b0f19] border border-blue-900/40 p-8 sm:p-12 space-y-6"
        >
        ...
        <section className="rounded-3xl bg-gradient-to-r from-blue-950/60 via-[#0b0f19] to-blue-950/60 border border-blue-500/40 p-10 sm:p-14 text-center space-y-5 shadow-glow-sm">
          ...
          <p className="text-slate-300 text-sm max-w-xl mx-auto leading-relaxed">
            Experience our simulated plant floor dashboard to inspect live
            machine frequencies, thermal feeds, and automated diagnostic shift
            briefs.
          </p>
