...
export const Platform = ({ onOpenDashboard }) => {
  return (
    <section
      id="platform"
      className="py-24 bg-[#06080d] border-t border-b border-slate-900"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 rounded-3xl bg-[#0b0f19] border border-blue-900/40 p-8 flex flex-col justify-between space-y-6 hover:border-blue-500/40 transition-all">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm leading-relaxed max-w-xl">
                ...
                facility on a single interactive map. Green indicates peak
                operation; blue indicates scheduled maintenance windows.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-slate-800/80 font-mono text-xs">
              <button
                onClick={() =>
                  onOpenDashboard &&
                  onOpenDashboard({ assetId: "PUMP-04", tab: "sensors" })
                }
              ...
              >
                <span className="text-slate-400 block text-[10px] group-hover:text-blue-300">
                  FEED PUMPS →
                </span>
              ...
              <button
                onClick={() =>
                  onOpenDashboard &&
                  onOpenDashboard({ assetId: "TURB-02", tab: "sensors" })
                }
                className="p-3 rounded-xl bg-[#06080d] hover:bg-blue-950/60 border border-slate-800 hover:border-blue-500/40 text-left transition-all group"
              >
                <span className="text-slate-400 block text-[10px] group-hover:text-blue-300">
              ...
              <button
                onClick={() =>
                  onOpenDashboard &&
                  onOpenDashboard({ assetId: "CNC-12", tab: "sensors" })
                }
                className="p-3 rounded-xl bg-[#06080d] hover:bg-blue-950/60 border border-slate-800 hover:border-blue-500/40 text-left transition-all group"
              >
                <span className="text-slate-400 block text-[10px] group-hover:text-blue-300">
              ...
              <button
                onClick={() =>
                  onOpenDashboard &&
                  onOpenDashboard({ assetId: "COMP-01", tab: "sensors" })
                }
                className="p-3 rounded-xl bg-[#06080d] hover:bg-blue-950/60 border border-slate-800 hover:border-blue-500/40 text-left transition-all group"
              >
                <span className="text-slate-400 block text-[10px] group-hover:text-blue-300">
          ...
          <div className="rounded-3xl bg-[#0b0f19] border border-blue-900/40 p-8 flex flex-col justify-between space-y-6 hover:border-blue-500/40 transition-all">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                ...
                anomaly starts brewing—not after damage has already occurred.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#06080d] border border-blue-900/30 font-mono text-xs text-blue-300">
              ...
              <span>
                "Line 4 Motor: Early bearing friction. Inspect at shift pause."
              </span>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-[#0b0f19] border border-blue-900/40 p-8 flex flex-col justify-between space-y-6 hover:border-blue-500/40 transition-all">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Air-gapped architecture designed for defense and cleanroom
                standards. Your telemetry never leaves your factory network.
              </p>
            </div>
          ...
          <div className="lg:col-span-2 rounded-3xl bg-[#0b0f19] border border-blue-900/40 p-8 flex flex-col justify-between space-y-6 hover:border-blue-500/40 transition-all">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm leading-relaxed max-w-xl">
                ...
                production schedules and pays for your monitoring hardware
                during your very first maintenance cycle.
              </p>
            </div>
