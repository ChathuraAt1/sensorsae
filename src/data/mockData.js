...
export const marketingCaseStudies = [
  {
    ...
    headline: "Saved $14.2M by preventing cleanroom vacuum pump breakdown",
    story: "Two weeks before our biggest production run, SENSORSAE detected abnormal acoustic friction in our primary cleanroom exhaust pump. We scheduled a 30-minute bearing swap during planned shift change and avoided a 12-day shutdown.",
    author: "Marcus V.",
    role: "VP of Fab Operations",
    metric: "0 Min Lost Production",
  ...
  },
  {
    ...
    headline: "Cut robotic welding micro-stoppages by 78% in 60 days",
    story: "Our welding line used to suffer dozens of unexplainable 3-minute halts every shift. SENSORSAE pinpointed the exact spindle wear causing thermal drift. Technicians love querying the AI copilot during shift handovers.",
    author: "Kenji T.",
    role: "Plant Modernization Lead",
    metric: "78% Less Stoppages",
  ...
  },
  {
    ...
    headline: "Eliminated emergency helicopter repairs for turbine generators",
    story: "Emergency offshore maintenance runs cost over $80,000 per dispatch. With SENSORSAE giving us a 4-week warning horizon, our maintenance boat only sails for planned, batched overhauls.",
    author: "Elena R.",
